...
class Applied_Page extends StatefulWidget {
  const Applied_Page({Key? key}) : super(key: key);
...
class _Applied_PageState extends State<Applied_Page> {
  ...
  moveToHome() async {
    ...
    var response = await http.get(
        Uri.parse("https://3b8b-103-244-121-12.ngrok-free.app/emp/getapplieddata/${authcontroller.employephonenumber.value.text}"));
