...
class Industry_settings extends StatefulWidget {
  const Industry_settings({Key? key}) : super(key: key);

  @override
  State<Industry_settings> createState() => _Industry_settingsState();
}

class _Industry_settingsState extends State<Industry_settings> {
  @override
